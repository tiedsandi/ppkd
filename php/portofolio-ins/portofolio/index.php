            ...
            <div class="row no-gutters block-9">
                <div class="col-md-6 order-md-last d-flex">
                    ...
                    if (isset($_POST['kirim'])) {
                        ...
                        $cekEmail = mysqli_query($conn,"SELECT email from kontak WHERE email = '$email'");
                        $rowEmail = mysqli_fetch_assoc($cekEmail);
                        if($rowEmail){
                            echo "<script>alert('Email sudah digunakan')</script>";
                        }else {
                            $insert = mysqli_query($conn, "INSERT INTO kontak (nama, email, subjek, pesan) VALUES ('$nama', '$email', '$subject', '$pesan')");
                            if ($insert) {
